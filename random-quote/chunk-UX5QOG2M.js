...
var _FieldsService = class _FieldsService {
  constructor(http, baseUrl) {
    ...
    this.fieldList$ = this.fields$.asObservable();
  }
  getFields() {
    return this.http.get(`${this.baseUrl}/fields`);
  }
};
_FieldsService.\u0275fac = function FieldsService_Factory(t) {
  return new (t || _FieldsService)(\u0275\u0275inject(HttpClient), \u0275\u0275inject(API));
};
_FieldsService.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _FieldsService, factory: _FieldsService.\u0275fac, providedIn: "root" });
var FieldsService = _FieldsService;
...
function propDecoratorFactory(name2, fallback) {
  function propDecorator(target, propName, originalDescriptor) {
    ...
    if (Object.prototype.hasOwnProperty.call(target, privatePropName)) {
      warn(`The prop "${privatePropName}" is already exist, it will be overrided by ${name2} decorator.`);
    }
...
_NzConfigService.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({
...
_NzIconService.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({
...
_NzIconPatchService.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({
...
_NzIconDirective.\u0275dir = /* @__PURE__ */ \u0275\u0275defineDirective({
...
_NzIconModule.\u0275mod = /* @__PURE__ */ \u0275\u0275defineNgModule({
  type: _NzIconModule
});
_NzIconModule.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({});
...
// src/app/features/branch-item/branch-item.component.ts
var _c02 = (a0, a1) => ({ "from-purple-500 to-pink-500 text-white tag-button-selected": a0, "from-purple-100 to-pink-100 text-gray-700 tag-button-deselected": a1 });
var _c1 = (a0, a1) => ({ "bg-green-500 led-light-on": a0, "bg-gray-500 ": a1 });
var _BranchItemComponent = class _BranchItemComponent {
  constructor() {
    this.label = "";
    this.countChecked = new EventEmitter();
    this.disabled = false;
    this.onChange = () => {
    };
    this.onTouched = () => {
  ...
  changeCustom() {
    ...
    this.countChecked.emit(this.isSelected);
    this.onChange(this.isSelected);
  }
};
_BranchItemComponent.\u0275fac = function BranchItemComponent_Factory(t) {
  return new (t || _BranchItemComponent)();
};
_BranchItemComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _BranchItemComponent, selectors: [["app-branch-item"]], inputs: { label: "label" }, outputs: { countChecked: "countChecked" }, standalone: true, features: [\u0275\u0275ProvidersFeature([
  {
    provide: NG_VALUE_ACCESSOR,
    useExisting: forwardRef(() => _BranchItemComponent),
    multi: true
  }
]), \u0275\u0275StandaloneFeature], decls: 4, vars: 9, consts: [[1, "px-4", "py-2", "rounded-full", "transition", "duration-450", "ease-in-out", "transform", "active:translate-y-1", "cursor-pointer", "shadow-md", "flex", "bg-gradient-to-r", 3, "click", "ngClass"], [1, "select-none"], [1, "w-3", "h-3", "rounded-full", "transition-all", "duration-400", "shadow-lg", "ml-1.5", "mt-1", 3, "ngClass"]], template: function BranchItemComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 0);
    \u0275\u0275listener("click", function BranchItemComponent_Template_div_click_0_listener() {
      return ctx.changeCustom();
    });
  ...
  if (rf & 2) {
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction2(3, _c02, ctx.isSelected, !ctx.isSelected));
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(ctx.label);
    \u0275\u0275advance();
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction2(6, _c1, ctx.isSelected, !ctx.isSelected));
  }
}, dependencies: [NzTagModule, NzIconModule, NzFlexModule, CommonModule, NgClass], styles: ["\n\n.led-light[_ngcontent-%COMP%] {\n  width: 50px;\n  height: 50px;\n  border-radius: 50%;\n  transition: all 0.3s ease;\n  box-shadow: 0 0 10px rgba(0, 0, 0, 0.5);\n}\n.led-light-off[_ngcontent-%COMP%] {\n  box-shadow: 0 0 10px #6b7280;\n}\n.tag-button-selected[_ngcontent-%COMP%] {\n  box-shadow: 0 4px 14px 0 rgba(0, 118, 255, 0.39);\n}\n.tag-button-deselected[_ngcontent-%COMP%] {\n  box-shadow: 0 4px 6px 0 rgba(0, 0, 0, 0.1);\n}\n/*# sourceMappingURL=branch-item.component.css.map */"] });
var BranchItemComponent = _BranchItemComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(BranchItemComponent, { className: "BranchItemComponent", filePath: "src\\app\\features\\branch-item\\branch-item.component.ts", lineNumber: 28 });
})();
...
function warnTriggerBuild(name2, warnings) {
  (typeof ngDevMode === "undefined" || ngDevMode) && console.warn(`The animation trigger "${name2}" has built with the following warnings:${createListOfWarnings(warnings)}`);
}
...
var AnimationTrigger = class {
  constructor(name2, ast, _normalizer) {
    ...
    this.fallbackTransition = createFallbackTransition(name2, this.states, this._normalizer);
  }
  get containsQueries() {
...
var AnimationTransitionNamespace = class {
  ...
  _getTrigger(name2) {
    const trigger = this._triggers.get(name2);
    if (!trigger) {
...
var TransitionAnimationEngine = class {
  ...
  registerTrigger(namespaceId, name2, trigger) {
    let ns = this._namespaceLookup[namespaceId];
    if (ns && ns.register(name2, trigger)) {
...
var AnimationEngine = class {
  ...
  registerTrigger(componentId, namespaceId, hostElement, name2, metadata) {
    ...
    if (!trigger) {
      ...
      trigger = buildTrigger(name2, ast, this._normalizer);
      this._triggerCache[cacheKey] = trigger;
    }
    this._transitionEngine.registerTrigger(namespaceId, name2, trigger);
  }
  register(namespaceId, hostElement) {
...
// src/app/shared/component/success/success.component.ts
var _SuccessComponent = class _SuccessComponent {
  ngOnInit() {
...
_SuccessComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SuccessComponent, selectors: [["app-success"]], standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 0, vars: 0, template: function SuccessComponent_Template(rf, ctx) {
}, styles: ["\n\n@keyframes _ngcontent-%COMP%_checkmark {\n  0% {\n    stroke-dasharray: 0, 100;\n  }\n  100% {\n    stroke-dasharray: 50, 0;\n  }\n}\n.checkmark-container[_ngcontent-%COMP%] {\n  width: 200px;\n  height: 200px;\n  display: flex;\n  justify-content: center;\n  align-items: center;\n  background-color: transparent;\n}\n.checkmark-circle[_ngcontent-%COMP%] {\n  stroke: #4caf50;\n  stroke-width: 2;\n  animation: checkmark-circle 0.4s ease-in-out forwards;\n}\n.checkmark-check[_ngcontent-%COMP%] {\n  stroke: #4caf50;\n  stroke-width: 2;\n  stroke-linecap: round;\n  stroke-dasharray: 50;\n  stroke-dashoffset: 50;\n  animation: _ngcontent-%COMP%_checkmark 0.4s 0.4s ease-in-out forwards;\n}\n.fade-in[_ngcontent-%COMP%] {\n  animation: _ngcontent-%COMP%_fadeIn ease 2s;\n  -webkit-animation: _ngcontent-%COMP%_fadeIn ease 2s;\n  -moz-animation: fadeIn ease 2s;\n  -o-animation: fadeIn ease 2s;\n  -ms-animation: fadeIn ease 2s;\n  opacity: 1;\n}\n.fade-out[_ngcontent-%COMP%] {\n  animation: _ngcontent-%COMP%_fadeOut ease 2s;\n  -webkit-animation: _ngcontent-%COMP%_fadeOut ease 2s;\n  -moz-animation: fadeOut ease 2s;\n  -o-animation: fadeOut ease 2s;\n  -ms-animation: fadeOut ease 2s;\n  opacity: 0;\n}\n@keyframes _ngcontent-%COMP%_fadeIn {\n  0% {\n    opacity: 0;\n  }\n  100% {\n    opacity: 1;\n  }\n}\n@keyframes _ngcontent-%COMP%_fadeOut {\n  0% {\n    opacity: 1;\n  }\n  100% {\n    opacity: 0;\n  }\n}\n/*# sourceMappingURL=success.component.css.map */"] });
var SuccessComponent = _SuccessComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SuccessComponent, { className: "SuccessComponent", filePath: "src\\app\\shared\\component\\success\\success.component.ts", lineNumber: 10 });
})();

// src/app/shared/components/error-view/error-view.component.ts
var _ErrorViewComponent = class _ErrorViewComponent {
  constructor() {
    this.error = "";
  }
};
_ErrorViewComponent.\u0275fac = function ErrorViewComponent_Factory(t) {
  return new (t || _ErrorViewComponent)();
};
_ErrorViewComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ErrorViewComponent, selectors: [["app-error-view"]], inputs: { error: "error" }, standalone: true, features: [\u0275\u0275StandaloneFeature], decls: 3, vars: 1, consts: [[1, "h-screen"]], template: function ErrorViewComponent_Template(rf, ctx) {
  if (rf & 1) {
...
var ErrorViewComponent = _ErrorViewComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ErrorViewComponent, { className: "ErrorViewComponent", filePath: "src\\app\\shared\\components\\error-view\\error-view.component.ts", lineNumber: 10 });
})();

// src/app/shared/services/redirect.service.ts
...
_RedirectService.\u0275fac = function RedirectService_Factory(t) {
  return new (t || _RedirectService)(\u0275\u0275inject(Router));
};
_RedirectService.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _RedirectService, factory: _RedirectService.\u0275fac, providedIn: "root" });
var RedirectService = _RedirectService;

// src/app/features/fields-list/fields-list.component.ts
var _c04 = (a0, a1) => ({ "transition duration-450 ease-in-out transform active:translate-y-1  focus:ring-2 focus:ring-gray-300 cursor-pointer focus:outline-none hover:bg-gray-200": a0, "bg-gray-500 ": a1 });
function FieldsListComponent_Conditional_6_div_1_app_branch_item_4_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "app-branch-item", 11);
    \u0275\u0275listener("countChecked", function FieldsListComponent_Conditional_6_div_1_app_branch_item_4_Template_app_branch_item_countChecked_0_listener($event) {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.countChecked($event));
    });
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const branch_r4 = ctx.$implicit;
    \u0275\u0275propertyInterpolate("id", branch_r4[0]);
    \u0275\u0275propertyInterpolate("formControlName", branch_r4[0]);
    \u0275\u0275property("label", branch_r4[1]);
  }
}
function FieldsListComponent_Conditional_6_div_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 7)(1, "div", 8);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(3, "div", 9);
    \u0275\u0275template(4, FieldsListComponent_Conditional_6_div_1_app_branch_item_4_Template, 1, 3, "app-branch-item", 10);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const field_r5 = ctx.$implicit;
    \u0275\u0275property("formGroupName", field_r5.key);
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", field_r5.label, " ");
    \u0275\u0275advance();
    \u0275\u0275property("nzGap", "middle")("nzWrap", "wrap");
    \u0275\u0275advance();
    \u0275\u0275property("ngForOf", field_r5.value);
  }
}
function FieldsListComponent_Conditional_6_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "form", 4);
    \u0275\u0275listener("ngSubmit", function FieldsListComponent_Conditional_6_Template_form_ngSubmit_0_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.onSubmit());
    });
    \u0275\u0275template(1, FieldsListComponent_Conditional_6_div_1_Template, 5, 5, "div", 5);
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275property("formGroup", ctx_r1.fieldsForm);
    \u0275\u0275advance();
    \u0275\u0275property("ngForOf", ctx_r1.fieldsArray);
    \u0275\u0275advance();
    \u0275\u0275property("ngClass", \u0275\u0275pureFunction2(4, _c04, ctx_r1.canSubmit, !ctx_r1.canSubmit))("disabled", !ctx_r1.canSubmit);
  }
}
var _FieldsListComponent = class _FieldsListComponent {
  constructor(fieldsService, webStorageService, redirectService) {
    this.fieldsService = fieldsService;
    this.webStorageService = webStorageService;
    this.redirectService = redirectService;
    this.fieldsArray = [];
    this.branchesCached = {};
    this.countCheckedNum = 0;
    this.canSubmit = false;
    this.description = "Select at least one element from which to receive random quotes.";
    this.getFieldError = null;
  }
  ngOnInit() {
    this.branchesCached = this.webStorageService.getBranches();
    this.buildForm();
  }
  buildForm() {
    const isBranchesCached = !!this.branchesCached;
    this.fieldsService.getFields().subscribe((fields) => {
      const fieldsMap = {};
      for (const [fieldKey, fieldValue] of Object.entries(fields)) {
        let branches = {};
        let branchesArray = [];
        for (const [branchKey, branchValue] of Object.entries(fieldValue.branches)) {
          branches[branchKey] = new FormControl(isBranchesCached ? this.initCountChecked(fieldKey, branchKey) : false, {
            nonNullable: true
          });
          branchesArray.push([branchKey, branchValue]);
        }
        fieldsMap[fieldKey] = new FormGroup(__spreadValues({}, branches));
      ...
      this.fieldsForm = new FormGroup(__spreadValues({}, fieldsMap));
      this.canSubmit = this.countCheckedNum > 0;
    });
  }
  initCountChecked(fieldKey, branchKey) {
    let isChecked = this.branchesCached[fieldKey]?.indexOf(branchKey) >= 0;
    if (isChecked) {
      this.countCheckedNum += 1;
    }
    return isChecked;
  }
  countChecked(event) {
  ...
  onSubmit() {
    let branchesSelectedObj = {};
    for (const [fieldKey, branchesChecked] of Object.entries(this.fieldsForm.value)) {
      let branchesSelected = [];
      for (const [branchKey, isChecked] of Object.entries(branchesChecked)) {
        if (isChecked) {
          branchesSelected.push(branchKey);
        }
      }
      if (branchesSelected.length > 0) {
        branchesSelectedObj[fieldKey] = branchesSelected;
      }
    }
    this.webStorageService.saveBranches(branchesSelectedObj);
    this.redirectService.redirectToQuote();
  }
  checkForm() {
  }
};
_FieldsListComponent.\u0275fac = function FieldsListComponent_Factory(t) {
  return new (t || _FieldsListComponent)(\u0275\u0275directiveInject(FieldsService), \u0275\u0275directiveInject(WebStorageService), \u0275\u0275directiveInject(RedirectService));
};
_FieldsListComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _FieldsListComponent, selectors: [["app-fields-list"]], standalone: true, features: [\u0275\u0275ProvidersFeature([FieldsService, WebStorageService]), \u0275\u0275StandaloneFeature], decls: 7, vars: 2, consts: [[1, "text-center", "text-white", "mt-14", "mb-16"], [1, "mb-10", "font-bold", "text-lg"], [1, "mb-2", "mt-4"], [3, "formGroup"], [3, "ngSubmit", "formGroup"], ["class", "mb-12", 3, "formGroupName", 4, "ngFor", "ngForOf"], [1, "bg-gray-100", "text-base", "text-black", "font-semibold", "py-2", "px-12", "sm:py-3", "sm:px-12", "md:py-4", "md:px-16", "lg:font-bold", "lg:py-5", "lg:px-20", "rounded-full", 3, "ngClass", "disabled"], [1, "mb-12", 3, "formGroupName"], [1, "font-bold", "text-lg", "mb-2"], ["nz-flex", "", 3, "nzGap", "nzWrap"], ["class", "form-control", 3, "id", "formControlName", "label", "countChecked", 4, "ngFor", "ngForOf"], [1, "form-control", 3, "countChecked", "id", "formControlName", "label"]], template: function FieldsListComponent_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 0);
    \u0275\u0275element(1, "app-success");
    \u0275\u0275elementStart(2, "div", 1);
    \u0275\u0275element(3, "app-svg-quote");
    \u0275\u0275elementStart(4, "p", 2);
    \u0275\u0275text(5);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(6, FieldsListComponent_Conditional_6_Template, 4, 7, "form", 3);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    \u0275\u0275advance(5);
    ...
    \u0275\u0275advance();
    \u0275\u0275conditional(6, ctx.fieldsForm ? 6 : -1);
  }
}, dependencies: [
  CommonModule,
  NgClass,
...
var FieldsListComponent = _FieldsListComponent;
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(FieldsListComponent, { className: "FieldsListComponent", filePath: "src\\app\\features\\fields-list\\fields-list.component.ts", lineNumber: 46 });
})();
...
@angular/platform-browser/fesm2022/animations.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-UX5QOG2M.js.map
